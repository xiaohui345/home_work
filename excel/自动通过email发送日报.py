...
if __name__=='__main__':
	# 用windows 定时执行 python程序的时候，需要把 各个文件路径 写完整
	# 以上是很重要的，不然系统将找不到你的文件
	source_xls = r'E:\AI课程\基础课程\办公自动化\code\excel\楼宇安防.xls'
	save_path =r'E:\AI课程\基础课程\办公自动化\code\excel\楼宇安防_日报.xls'
